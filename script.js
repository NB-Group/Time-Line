...
function rePhoto() {
    ...
    for (var i = 0; i < fileList.length; i++) {
        ...
        img.attr("style", "width: 80%;height: 80%;box-shadow: 0.3rem 0.3rem 0.6rem var(--greyLight-2), -0.2rem -0.2rem 0.5rem var(--white);    border-radius: 0.8rem; margin-left:10%;height: auto;margin-top:3px");
...
function movesidebar(){
    if($("#sidebar").hasClass("moveLeft"))
    {
        $("#sidebar").removeClass("moveLeft");
        $("#sidebar").addClass("moveRight");
    }
    else
    {
        $("#sidebar").removeClass("moveRight");
        $("#sidebar").addClass("moveLeft");
    }
}